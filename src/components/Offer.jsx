...
export default function Offer() {
  const data = [
    {
      text: "La mejor guía de viajes siempre para sus servicios",
      icon: <BsPerson />,
      color: "red",
    },
    {
      text: "Servicios de primera clase prestados para usted",
      icon: <BiWorld />,
      color: "green",
    },
    {
      text: "Asistencia para usted 24/7",
      icon: <BsHeadphones />,
      color: "yellow",
    },
  ];
  return (
    <Section id="offer">
      ...
      <div className="content">
        <div className="title">
          <h1>Te ofresemos estas posibilidas para que dsfrutes mas tu viaje...</h1>
        </div>
        <ul className="list">
