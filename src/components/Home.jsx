  ...
  return (
    <Section>
      ...
      <div className="content">
        <div className="info">
          <h1>Es el momento de</h1>
          <h1>Explorar <Typed className='typed' strings={textLines}typeSpeed={75} loop backSpeed={75} smartBackspace={true} /> </h1>
